...
> CH › @yousef_labban1
> CH › @yousef_labban1
~> DEVELOPER › @yousef_labban
]])
if io.open("library/redis.lua","r") then
io.close(io.open("library/redis.lua","r"))
print("done => redis.lua")
else
io.popen("cd library && wget https://raw.githubusercontent.com/Yosef-lbban/RaVeN/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Yosef-lbban/Files_RaVeN/main/File_Bot/commands.lua") 
...
io.popen("mkdir File_Bot") 
if io.open("File_Bot/all.lua","r") then
io.close(io.open("File_Bot/all.lua","r"))
print("done => all.lua")
else
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Yosef-lbban/Files_RaVeN/main/File_Bot/all.lua") 
print("end wget => all.lua")
end
io.popen("mkdir File_Bot") 
if io.open("File_Bot/Reply.lua","r") then
io.close(io.open("File_Bot/Reply.lua","r"))
print("done => Reply.lua")
else
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Yosef-lbban/Files_RaVeN/main/File_Bot/Reply.lua") 
print("end wget => Reply.lua")
end
io.popen("mkdir File_Bot") 
if io.open("File_Bot/games.lua","r") then
io.close(io.open("File_Bot/games.lua","r"))
print("done => games.lua")
else
...
local UserName = (data.username_ or "yousef_labban1")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@yousef_labban")  
...
local bl = ' *🇸🇦 ︙اهلا عزيزي آلمـطـور*\n*🇸🇦 ︙آنت آلمـطـور آلآسـآسـي للبوت*\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n*🇸🇦 ︙تسـتطـيع‌‏ آلتحگم باوامر البوت*\n*🇸🇦 ︙من خلاال الكيبورت خاص بك*\n*🇸🇦 ︙قناة سورس البوت *[اضغط هنا](t.me/yousef_labban1)'
local keyboard = {
{'الاحصائيات ✫','قناه تحديثات البوت ✫'},
{'تعطيل التواصل ✫','تفعيل التواصل ✫'},
{'ضع اسم للبوت ✫','المطورين ✫','قائمة العام ✫'},
{'الثانويين ✫','مسح الثانويين ✫'},
{'المشتركين ✫','القروبات ✫'},
{'ضع رسالة ستارت ✫','حذف رسالة ستارت ✫'},
{'اذاعه ✫','اذاعه خاص ✫'},
{'اذاعه بالتثبيت ✫','قائمة الكتم العام ✫'},
{'تغير رسالة الاشتراك','حذف رسالة الاشتراك ✫','تغير الاشتراك'},
...
if text == 'الغاء' or text == 'الغاء ✫' then   
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙الغاء حفظ رسالة ستارت*')
...
if text == 'ضع رسالة ستارت ✫' and DevRaVeNW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙ارسل لي الرسالة الان*')
return false
end
if text == 'حذف رسالة ستارت ✫' and DevRaVeNW(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/RaVeN/main/RaVeN.lua')
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙تم تحديث السورس* \n*🇸🇦 ︙لديك اخر اصدار لسورس يوسف*\n*🇸🇦 ︙الاصدار » { 2.8v}*')
dofile('RaVeN.lua')  
end
if text == 'الاصدار ✫' and DevRaVeNW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙اصدار سورس يوسف* \n*🇸🇦 ︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and DevRaVeNW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🇸🇦 ︙[تحديثات البوت](t.me/yousef_labban1) \n🇸🇦 ︙[قناه السورس](t.me/yousef_labban1)')
end
...
if text == 'القروبات ✫' and DevRaVeNW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *🇸🇦 ︙القروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("قائمة العام ✫") and DevRaVeNW(msg) then
...
if text == ("قائمة الكتم العام ✫") and DevRaVeNW(msg) then
...
if text == "تنظيف القروبات ✫" and DevRaVeNW(msg) then 
...
send(msg.chat_id_, msg.id_,'*🇸🇦 ︙عدد القروبات الان » { '..#group..' }'..RaVeNk..''..RaVeN..'*\n*🇸🇦 ︙الان عدد القروبات الحقيقي » { '..sendok..' } قروبات*\n')   
end
end
end,nil)
end
...
usertext = '*\n 🇸🇦 ︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'yousef_labban1')..')'
status  = '\n *🇸🇦 ︙تم ترقيته مطور*'
...
usertext = '\n *🇸🇦 ︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'yousef_labban1')..')'
status  = '\n*🇸🇦 ︙تم ترقيته مطور*'
...
if RaVeN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'yousef_labban1')..') \n 🇸🇦 ︙'..RaVeN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
local Text ='• قم بختيار الرقم الصحيح الموجود في الصورة\n• ليتم الغاء تقييدك الان'
keyboard = {} 
...
send(msg.chat_id_,0," *🇸🇦 ︙العضو :* {["..data.first_name_.."](T.ME/yousef_labban1)}\n🇸🇦 ︙["..RaVeN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *🇸🇦 ︙عذرا ↫* {["..data.first_name_.."](T.ME/yousef_labban1)}\n*🇸🇦 ︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text and text:match("^تغير رسالة الاشتراك$") and DevRaVeNW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *🇸🇦 ︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رسالة الاشتراك ✫" and DevRaVeNW(msg) then  
...
if text == "مسح الاسماء المكتومة" and Constructor(msg) and database:get(bot_id.."block:name:stats"..msg.chat_id_) == "open" then
database:del(bot_id.."RaVeN:blocname"..msg.chat_id_)
texts = "*🇸🇦 ︙تم مسح الاسماء المكتومة* "
send(msg.chat_id_, msg.id_, texts)
end
if text == "الاسماء المكتومة" and Constructor(msg) and database:get(bot_id.."block:name:stats"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, '*🇸🇦 ︙تم تعطيل الاسماء المكتومة*')
...
send(msg.chat_id_, msg.id_,'*🇸🇦 ︙تم تعيين '..teh..' كتوحيد للمجموعة*')
...
if text == "تفعيل الرسائل اليومية" and Manager(msg) then
send(msg.chat_id_, msg.id_, '*🇸🇦 ︙تم تفعيل الرسائل اليومية*')
database:set(bot_id.."msg:match:"..msg.chat_id_,true)
end
if text == "تعطيل الرسائل اليومية" and Manager(msg) then
send(msg.chat_id_, msg.id_,'*🇸🇦 ︙تم تعطيل الرسائل اليومية*')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫ سورس يوسف',url="t.me/yousef_labban1"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,"*🇸🇦 ︙تم تقييدك  لمده ساعة بسبب التكرار*") 
...
if text == "ترتيب الاوامر" and Constructor(msg) then
 ...
 database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصورة")
 database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
 database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصورة")
...
if text == 'تفعيل نسبة الانوثه' and Manager(msg) then   
if database:get(bot_id..'Cick:ano'..msg.chat_id_) then
Text = ' *🇸🇦 ︙تم تفعيل نسبة الانوثه*'
...
if text == 'تعطيل نسبة الانوثه' and Manager(msg) then  
if not database:get(bot_id..'Cick:ano'..msg.chat_id_) then
database:set(bot_id..'Cick:ano'..msg.chat_id_,true)  
Text = '\n *🇸🇦 ︙تم تعطيل نسبة الانوثه*'
else
Text = '\n *🇸🇦 ︙بالتاكيد تم تعطيل نسبة الانوثه*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'yousef_labban1')..') \n*🇸🇦 ︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == 'قفل المنشورات' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:Spam"..msg.chat_id_,'del')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'yousef_labban1')..') \n*🇸🇦 ︙تـم قفـل المنشورات* ')  
end,nil)   
elseif text == 'قفل المنشورات بالتقييد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:Spam"..msg.chat_id_,'ked')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'yousef_labban1')..') \n*🇸🇦 ︙تـم قفـل المنشورات بالتقييد* ')  
end,nil)
elseif text == 'قفل المنشورات بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:Spam"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'yousef_labban1')..') \n*🇸🇦 ︙تـم قفـل المنشورات بالكتم* ')  
end,nil)   
elseif text == 'قفل المنشورات بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:Spam"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'yousef_labban1')..') \n*🇸🇦 ︙تـم قفـل المنشورات بالطرد* ')  
end,nil)   
elseif text == 'فتح المنشورات' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
if text == ("مسح قائمة العام") and DevRaVeNW(msg) then
...
if DevRaVeNW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yosef-lbban/Files_RaVeN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *🇸🇦 ︙اهلا بك في متجر ملفات يوسف*\n*🇸🇦 ︙ملفات السورس ↓*\n*≪══════YL══════≫*\n\n"
local TextE = "\n*≪══════YL══════≫*\n *🇸🇦 ︙علامة تعني { ✓ } ملف مفعل*\n *🇸🇦 ︙علامة تعني { ✘ } ملف معطل*\n *🇸🇦 ︙قناة سورس يوسف ↓*\n".." *🇸🇦 ︙*[اضغط هنا لدخول](t.me/yousef_labban1) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yosef-lbban/Files_RaVeN/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RaVeN.lua')  
else
send(msg.chat_id_, msg.id_," *🇸🇦 ︙عذرا الملف لايدعم سورس يوسف* \n") 
end
return false
end
...
if text == ("مسح قائمة المالك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n *🇸🇦 ︙تم مسح قائمة المالك*')
return false
end
if text == 'قائمة المالك' and Sudo(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text ==("رفع الادامن") and Manager(msg) then
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local num2 = 0
local admins = data.members_
for i=0 , #admins do
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," *🇸🇦 ︙لا يوجد ادامن ليتم رفعهم*") 
else
send(msg.chat_id_, msg.id_," *🇸🇦 ︙تمت ترقيه { "..num2.." } من الادامن*") 
end
end,nil)   
end
...
if text == 'مسح الادامن' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🇸🇦 ︙تم مسح الادامن')
end
if text == ("الادامن") and Manager(msg) then
local list = database:smembers(bot_id..'Mod:User'..msg.chat_id_)
t = "\n *🇸🇦 ︙قائمة الادامن* \n*≪══════YL══════≫*\n"
keyboard = {
{{text = 'مسح الادامن',callback_data=msg.sender_user_id_.."DelLsta".."160"}},
}
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
if text == ("تاك للادامن") or text == ("صيح الادامن") then
local list = database:smembers(bot_id..'Mod:User'..msg.chat_id_)
t = "\n *🇸🇦 ︙وينكم تعالو يريدوكم بقروب* \n*≪══════YL══════≫*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *🇸🇦 ︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'yousef_labban1')..')'
status  = '\n*🇸🇦 ︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *🇸🇦 ︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'yousef_labban1')..')'
status  = '\n*🇸🇦 ︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *🇸🇦 ︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *🇸🇦 ︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'yousef_labban1')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *🇸🇦 ︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'yousef_labban1')..')'
local  statuss  = '\n*🇸🇦 ︙تم رفع العضــو الحات في القروب* \n*🇸🇦 ︙تعال حبي الحات نطيني شنو رئيك11*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
return send(msg.chat_id_, msg.id_,"*🇸🇦 ︙تم وضع وقت التنظيف ("..GetDo..") ساعة*")
end
...
send(msg.chat_id_,msg.id_," *🇸🇦 ︙لا توجد رسالة مثبته*")  
...
if text == "حذف الصورة" or text == "مسح الصورة" and GetChannelMember(msg) then   
if Mod(msg) then
...
if text == "مسح قائمة المنع"and Manager(msg) then   
...
if text == "قائمة المنع" and Manager(msg) then   
...
if text == 'مسح قائمة منع المتحركات' and Manager(msg) then     
database:del(bot_id.."filteranimation"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙تم مسح قائمة منع المتحركات*')  
end
if text == 'مسح قائمة منع الصور' and Manager(msg) then     
database:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙تم مسح قائمة منع الصور*')  
end
if text == 'مسح قائمة منع الملصقات' and Manager(msg) then     
database:del(bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙تم مسح قائمة منع الملصقات*')  
end
------------------

if text == 'مسح رسالة المطور' and DevRaVeNW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *🇸🇦 ︙تم مسح رسالة المطور*')
end
if text == 'ضع رسالة المطور' and DevRaVeNW(msg) then
...
if text and text:match("^اضف صلاحية (.*)$") and Mod(msg) then 
...
if text and text:match("^مسح صلاحية (.*)$") and Mod(msg) then 
ComdNew = text:match("^مسح صلاحية (.*)$")
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *🇸🇦 ︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'yousef_labban1')..')'..'\n*🇸🇦 ︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'*🇸🇦 ︙تستطيع التنظيف 1000 رسالة كحد اقصى*') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
local RaVeN_Msg = {
'نعسان 🥺💕.',
'بعدين العب معاك موف فاضيلك اليوم ☹️.',
'نفسي اطردك😂.',
'نعم انا  '..Namebot..'',
'مشغول حالياً',
'عمري فداك '..Namebot..' عيني قول '
}
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,RaVeN)
local t = "\n*ツ قائمة الاعضاء* \n*≪══════YL══════≫*\n"
x = 0
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'يوسف')
local texting = {'*اسمي البطل  '..Namebot..'* ','*اسمي  '..Namebot..'* ','*أتعلم تقرأ اسمي '..Namebot..'* ','*تعال بكرا اليوم مو فاضيلك  '..Namebot..'* ','*أنا نايم '..Namebot..'* ','*قول بوت شوف اطردك ولالا*'}
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'yousef_labban1')..')'
local iduser = result.sender_user_id_
...
local amir = ' *🇸🇦 ︙عدد الادامن :* '..data.administrator_count_..
...
if text == ("الردود المتعددة") and Manager(msg) then
...
if #list == 0 then
text = " 🇸🇦 ︙لا يوجد ردود متعددة"
end
send(msg.chat_id_, msg.id_,'['..text..']')
end
if text == ("مسح الردود المتعددة") and BasicConstructor(msg) and GetChannelMember(msg) then   
local list = database:smembers(bot_id..'List:array'..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."Add:Rd:array:Text"..v..msg.chat_id_)   
database:del(bot_id..'List:array'..msg.chat_id_)
end
send(msg.chat_id_, msg.id_," *🇸🇦 ︙تم مسح الردود المتعددة*")
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n *🇸🇦 ︙تم تنزيل الكل من الرتب الاتيه* \n*🇸🇦 ︙المميزين ، الادامن ، المدراء ، المنشئين* \n')
end
...
send(msg.chat_id_, msg.id_, ' *🇸🇦 ︙تم حفظ الرسالة*')
...
*🇸🇦 ︙م10 ◂ اوامر الاعضاء*
*🇸🇦 ︙م11 لشرح أوامر الحماية*
ٴ*≪══════YL══════≫*ٴ
[Source Channel ](t.me/yousef_labban1) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اوامر الحماية', callback_data="/help1"},{text = 'اوامر الادامن', callback_data="/help2"}},
{{text = 'اوامر الوضع', callback_data="/help3"},{text = 'اوامر المسح', callback_data="/help4"}},
{{text = 'اوامر المنشئين', callback_data="/help5"},{text = 'اوامر المجموعة', callback_data="/help6"}},
...
{{text = 'Source Channel', url="t.me/yousef_labban1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = 'Source Channel', url="t.me/yousef_labban1"}},
{{text = 'مطور السورس', url="t.me/yousef_labban"}},
}
send_inlin_key(msg.chat_id_," *🇸🇦 ︙قائمة الالعاب الاحترافيه اضغط للعب*",_key,msg.id_)
else
...
GetDo = https.request('https://vvvzvv.ml/apiyoytapi/tiktok.php?u='..URL.escape(Textm))
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ*≪══════YL══════≫*ٴ✫∫○ٴ\n🇸🇦 ︙[Source Channel](t.me/yousef_labban1) ')
end
...
GetDo = https.request('https://vvvzvv.ml/apiyoytapi/up.php?Type=ins&url='..URL.escape(Textm))
DoGet = JSON.decode(GetDo)
if DoGet.link == false then 
send(msg.chat_id_, msg.id_,'*🇸🇦 ︙تأكد من الرابط .*')
return false
...
GetDo = https.request('https://vvvzvv.ml/apiyoytapi/st.php?username='..URL.escape(Textm))
DoGet = JSON.decode(GetDo)
...
if text == "شنو رئيك11 بهذا" or text == "شنو رئيك11 بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ادب سسز يباوع علي بنات ??🥺"," مو خوش ولد 😶","زاحف وما احبه 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك11 بهاي" or text == "شنو رئيك11 بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"دور حلوين 🤕😹","جكمه وصخه عوفها ☹️😾","حقيره ومنتكبره 😶😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك11ه" or text == "شنو رئيك11" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ولك هيو لتندك بسيادك لو بهاي 👞👈","ميستاهل اتعبي روحي ويا لانه عار","عوفه يروحي هاذا طيز يضل يمضرط🤣"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك11" or text == "شنو رئيك11" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","مابوس ولي😌😹","خدك/ج نضيف 😂","الشنو رئيك11 بالف حمبي 🌝💋","خلي يزحفلي واشنو رئيك11 🙊😻","كل شويه اشنو رئيك11 كافي 😏","مااشنو رئيك11 والله هذا زاحف🦎","محح هاي لحاته صاكه??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'رجوع',callback_data=data.sender_user_id_.."Bbk"..OnID}},{{text = 'Source Channel', url="t.me/yousef_labban1"}},}
...
{{text = 'sᴏᴜʀᴄᴇ ʀᴀᴠᴇɴ',url='http://t.me/yousef_labban1'}},
}
...
if text ==  ""..Name_Bot..' شنو رئيك11 بهاذا' and tonumber(msg.reply_to_message_id_) > 0 then 
...
if text == "نسبة الحب" or text == "نسبة حب" and msg.reply_to_message_id_ ~= 0 and Mod(msg) then
if not database:get(bot_id..'Cick:lov'..msg.chat_id_) then
...
if text == "نسبة الكره" or text == "نسبة كره" and msg.reply_to_message_id_ ~= 0 and Mod(msg) then
if not database:get(bot_id..'Cick:krh'..msg.chat_id_) then
...
if text == "نسبة رجولة" or text == "نسبة الرجولة" and msg.reply_to_message_id_ ~= 0 and Mod(msg) then
if not database:get(bot_id..'Cick:rjo'..msg.chat_id_) then
...
if text and text ~="نسبة رجولة" and database:get(bot_id..":"..msg.sender_user_id_..":rjo_Bots"..msg.chat_id_) == "sendrjoe" then
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
xl = '*نسبة رجولة* *'..text..'* هي : *\n '..sendnuj..'%*'
send(msg.chat_id_, msg.id_,xl) 
database:del(bot_id..":"..msg.sender_user_id_..":rjo_Bots"..msg.chat_id_)
end
if text == "نسبة الانوثه" or text == "نسبة انوثه" and msg.reply_to_message_id_ ~= 0 and Mod(msg) then
if not database:get(bot_id..'Cick:ano'..msg.chat_id_) then
